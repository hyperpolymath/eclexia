...
- 🚧 LLVM backend: In development ([see roadmap](SELF-HOSTING-ROADMAP.md))
- 🚧 WASM backend: Planned
- 📅 Self-hosting: 6-9 months ([see roadmap](SELF-HOSTING-ROADMAP.md))
...
- **[Self-Hosting Roadmap](SELF-HOSTING-ROADMAP.md)** - Path to production readiness
...
🔥 **LLVM Backend** - Critical path to production ([see roadmap](SELF-HOSTING-ROADMAP.md#step-11-llvm-backend-8-10-weeks))
...
**Timeline:** 6-9 months to v1.0 ([detailed roadmap](SELF-HOSTING-ROADMAP.md))
...
**[Documentation](docs/)** •
**[Roadmap](SELF-HOSTING-ROADMAP.md)** •
