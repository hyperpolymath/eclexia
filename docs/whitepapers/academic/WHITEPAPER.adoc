...
2. link:#2-motivation[Motivation]
3. link:#3-the-economics-as-code-paradigm[The Economics-as-Code Paradigm]
4. link:#4-language-design[Language Design]
5. link:#5-type-system[Type System]
6. link:#6-operational-semantics[Operational Semantics]
7. link:#7-runtime-system[Runtime System]
8. link:#8-shadow-price-computation[Shadow Price Computation]
9. link:#9-carbon-aware-scheduling[Carbon-Aware Scheduling]
10. link:#10-implementation[Implementation]
11. link:#11-evaluation[Evaluation]
12. link:#12-related-work[Related Work]
13. link:#13-future-work[Future Work]
14. link:#14-conclusion[Conclusion]
