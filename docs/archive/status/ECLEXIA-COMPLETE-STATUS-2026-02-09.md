...
| 12.2 | Seam analysis: compiler → runtime boundary | 4h | ANALYZED (see docs/analysis/SEAM_ANALYSIS.md: runtime ingestion, runtime health server wiring; interpreter carbon ingestion still to wire) |
