...
1. link:#1-type-theory-and-programming-languages[Type Theory and Programming Languages]
2. link:#2-linear-and-substructural-type-systems[Linear and Substructural Type Systems]
3. link:#3-effect-systems-and-algebraic-effects[Effect Systems and Algebraic Effects]
4. link:#4-resource-aware-computing[Resource-Aware Computing]
5. link:#5-sustainable-and-green-computing[Sustainable and Green Computing]
6. link:#6-operations-research-and-optimization[Operations Research and Optimization]
7. link:#7-formal-verification[Formal Verification]
8. link:#8-category-theory[Category Theory]
9. link:#9-domain-theory[Domain Theory]
10. link:#10-compiler-construction[Compiler Construction]
11. link:#11-runtime-systems[Runtime Systems]
12. link:#12-dimensional-analysis[Dimensional Analysis]
13. link:#13-multi-objective-optimization[Multi-Objective Optimization]
14. link:#14-online-algorithms[Online Algorithms]
15. link:#15-session-types[Session Types]
