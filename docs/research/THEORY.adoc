...
2. link:#2-type-theoretic-foundations[Type-Theoretic Foundations]
3. link:#3-dependent-resource-types[Dependent Resource Types]
4. link:#4-categorical-semantics[Categorical Semantics]
5. link:#5-enriched-categories-and-graded-monads[Enriched Categories and Graded Monads]
6. link:#6-domain-theoretic-semantics[Domain-Theoretic Semantics]
7. link:#7-game-semantics[Game Semantics]
8. link:#8-realizability-semantics[Realizability Semantics]
9. link:#9-effect-systems-and-algebraic-effects[Effect Systems and Algebraic Effects]
10. link:#10-session-types-for-resources[Session Types for Resources]
11. link:#11-homotopy-type-theory-connections[Homotopy Type Theory Connections]
12. link:#12-coherence-and-canonicity[Coherence and Canonicity]
13. link:#13-normalization[Normalization]
14. link:#14-decidability-results[Decidability Results]
15. link:#15-extensions-and-future-directions[Extensions and Future Directions]
