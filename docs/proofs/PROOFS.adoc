...
1. link:#1-preliminaries[Preliminaries]
2. link:#2-type-safety[Type Safety]
3. link:#3-dimensional-correctness[Dimensional Correctness]
4. link:#4-type-inference[Type Inference]
5. link:#5-operational-semantics-properties[Operational Semantics Properties]
6. link:#6-resource-safety[Resource Safety]
7. link:#7-determinism[Determinism]
8. link:#8-economic-optimality[Economic Optimality]
9. link:#9-termination[Termination]
10. link:#10-soundness-of-constraint-solving[Soundness of Constraint Solving]
11. link:#11-metatheoretic-properties[Metatheoretic Properties]
