...
*Version:* 1.0 *Date:* December 2025 *Status:* Living Document

'''''

=== Overview

This document provides comprehensive bibliographic references for
Eclexia’s theoretical foundations, organized by topic. Each section
includes foundational works, recent developments, and connections to
Eclexia’s design.
...
[arabic]
. link:#1-type-theory-and-programming-languages[Type Theory and
Programming Languages]
. link:#2-linear-and-substructural-type-systems[Linear and Substructural
Type Systems]
. link:#3-effect-systems-and-algebraic-effects[Effect Systems and
Algebraic Effects]
. link:#4-resource-aware-computing[Resource-Aware Computing]
. link:#5-sustainable-and-green-computing[Sustainable and Green
Computing]
. link:#6-operations-research-and-optimization[Operations Research and
Optimization]
. link:#7-formal-verification[Formal Verification]
. link:#8-category-theory[Category Theory]
. link:#9-domain-theory[Domain Theory]
. link:#10-compiler-construction[Compiler Construction]
. link:#11-runtime-systems[Runtime Systems]
. link:#12-dimensional-analysis[Dimensional Analysis]
. link:#13-multi-objective-optimization[Multi-Objective Optimization]
. link:#14-online-algorithms[Online Algorithms]
. link:#15-session-types[Session Types]
...
This bibliography is a living document. Contributions of additional
relevant references are welcome via merge request.
