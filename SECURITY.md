...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/eclexia/security/advisories/new)
...
If you cannot use GitHub Security Advisories, you may open a private security advisory or contact the maintainers through GitHub.
...
- This repository (`hyperpolymath/eclexia`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/eclexia/security/advisories)
...
When using Eclexia, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/eclexia/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/eclexia/security/advisories/new) |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/eclexia/discussions) |
...
*Thank you for helping keep Eclexia and its users safe.*
