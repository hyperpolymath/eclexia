...
This directory contains Kubernetes manifests for deploying Eclexia in
production.
...
Each pod has two persistent volumes: 1. *data* (10GB) - General
application data 2. *shadow-prices* (5GB) - Shadow price state
(critical)

Shadow prices are preserved across pod restarts to maintain economic
continuity.
...
*License:* MPL-2.0 *Maintainer:* Jonathan D.A. Jewell
