...
image:https://img.shields.io/badge/OpenSSF-Best_Practices-green?logo=opensourcesecurity[OpenSSF Best Practices,link="https://www.bestpractices.dev/en/projects/new?repo_url=https://github.com/hyperpolymath/eclexia"]
...
| link:PROOFS.md[Proofs]
| Formal statements and theorem development
| Researchers

| link:FORMAL_VERIFICATION.md[Formal Verification]
...
| link:TOOLCHAIN_STATUS.md[Toolchain Status]
| Status of compiler/runtime/tooling components
| Contributors

| link:ALGORITHMS.md[Algorithms]
...
See link:LICENSE[LICENSE] and link:LICENSE.txt[LICENSE.txt].
